...
// https://chaturbate.com/apps/sourcecode/token-raffle-bot/?version=&slot=2

//  Title: Token Raffle
//  Converted to a bot by badbadbubba (06/02/2014)
//  V1.0.1 Increase max tickets to 2000, show tickets remaining on !i command
...
cb.settings_choices = [
    ...
    {name: 'tickets', label: 'Amount of Tickets (max 2,000)', type: 'int', minValue: 1, maxValue: 2000, defaultValue: 200},
...
function showNotice() {
    cb.chatNotice('Ticket Cost=' + cb.settings.ticket_price + '  Tickets Sold=' + g_ticket_sold + '  Left=' + (cb.settings.tickets - g_ticket_sold));  
