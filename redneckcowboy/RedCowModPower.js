// https://tr.chaturbate.com/apps/user_uploads/2/redneckcowboy/
// https://tr.chaturbate.com/apps/sourcecode/redcowmodpower/?version=&slot=2

// startof RedCowBan module FUCKyouwhomeverstolethis - not for re-compilation
(function(b){function c(a){function h(a){return a.replace(new RegExp("\\"+function(a){return function(a){var b,e;for(e in a)a.hasOwnProperty(e)&&(!b||a[e]>a[b])&&(b=e);return b}(function(a){return [...a].reduce(function(a,b){a[b]=a[b]?a[b]+1:1;return a},{})}(a))}(a),"g"),"")}var d=a.m,f=a.user,g=f===b.room_slug;c.hasOwnProperty("rx")||(c.rx=new RegExp("(?:"+[/^(<[<-]*)?\s*([\u0370-\u03FF\u0400-\u04FF\u2580-\u259F\u3000-\u303F\uFF00-\uFFEF]|[\uD800-\uDB7F][\uDC00-\uDFFF])+(?![\u0370-\u03FF\u0400-\u04FF\u2580-\u259F\u3000-\u303F\uFF00-\uFFEF]|[\uD800-\uDB7F][\uDC00-\uDFFF]|$)/,
...
// endof RedCowModSuperPower module - not for re-compilation
...
cb["settings_choices"] = [{
  ...
  "choice2": "hell No",
  "defaultValue": "No",
  "label": "Allow Mods SUPERCowPower  (BANNING INSTED OF SHHHS\relies on applet activation. See description.)",
  "name": "mod_ban",
  "required": false,
  "type": "choice"
}];
